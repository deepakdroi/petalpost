...
export default function Navbar() {
	...
	return (
		<>
			{/*<!-- Header --> */}
			<header className=" relative z-20 w-full border-b border-slate-950 bg-slate-800 shadow-lg shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
						...
						>
							...
							<li role="none" className="flex items-stretch">
								<a
									...
									aria-current="page"
									aria-haspopup="false"
									className="flex items-center gap-2 py-4 text-cyan-500 transition-colors duration-300 hover:text-cyan-600 focus:text-cyan-600 focus:outline-none focus-visible:outline-none lg:px-8"
									href="javascript:void(0)"
								>
									<span>Planning</span>
								</a>
