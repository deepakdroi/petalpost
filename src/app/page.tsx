...
import RoseImage from "@/img/rose_bg.jpg";
...
export default function Home() {
	return (
		<div className="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
			...
			<div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
				...
				<p className="text-lg text-gray-300 mb-8">
					Handpick the flowers for your loved ones.
				</p>
				<a
					href="#"
		...
		// 	<div className="container h-full mx-auto px-6 md:px-12">
		...
		// 					<a
		// 						href="#"
		// 						className="bg-gray-700 hover:bg-gray-600 text-white h-full font-bold py-3 px-6 rounded-md"
		// 					>
		// 						Learn More
		// 					</a>
		// 				</div>
